      ...
      <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        <div class="text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <p class="mb-8">
            ...
            the prevalence of populist views, conspiracy theories, and fake news. We aim to combat misinformation,
          ...
          <p class="my-8">
            <i>“Democracy is never a final achievement. It is a call to an untiring effort.”</i> — John F. Kennedy
          </p>
        </div>
        <img
      ...
      <div class="items-center gap-8 lg:grid lg:grid-cols-2 xl:gap-16">
        ...
        <div class="text-gray-500 sm:text-lg dark:text-gray-400">
          ...
          <p class="mb-8">
            ...
            websites, apps, podcasts, and social media channels, we aim not only to inform but also to empower
            individuals to actively participate in the democratic process and uphold the values of truth, reason, and
  ...
  <section class="bg-primary">
    ...
    >
      <div class="col-span-2">
        ...
        <p class="mb-8">
          Actions speak louder than words. At our organization, we prioritize doing over talking. Through our unwavering
          dedication, we've engaged with a multitude of users, rallied a team of passionate volunteers, and extended our
      ...
      <div class="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
        <div>
          <svg
            ...
            viewBox="0 0 512 512"
            class="mb-2 h-10 w-10 text-purple-600 md:h-12 md:w-12 dark:text-purple-500"
            fill="currentColor"
          >
            <path
    ...
    <div class="mx-auto max-w-screen-xl px-4 py-8 text-center lg:px-6 lg:py-24">
      <figure class="mx-auto max-w-screen-md">
        ...
        <figcaption class="mt-6 flex items-center justify-center space-x-3">
          <img class="h-6 w-6 rounded-full" src="/Maren.png" alt="profile picture" />
          <div class="flex items-center divide-x-2 divide-gray-700">
            <div class="text-color-primary pr-3 font-medium">Maren Heinz</div>
            <div class="text-color-secondary pl-3 text-sm font-light">CEO FollowTheVote</div>
          </div>
        </figcaption>
      </figure>
    </div>
