...
// Define the props to match the "Project" data architecture
      ...
      <div class="max-w-screen-md px-4 py-8 mx-auto lg:px-6">
        <div class="max-w-screen-md mx-auto mb-8 lg:mb-12">
          <div class="flex items-center mb-7">
            ...
            <h1 class="max-w-2xl ml-2 text-4xl font-extrabold leading-none tracking-tight md:text-5xl xl:text-6xl dark:text-white" >{{ name || 'Default Title' }}</h1>
          </div>
